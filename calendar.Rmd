...
- Homework 7 due Thur Apr 28 by 11pm --- population-averaged models (i.e., marginal models, GEEs), subject-specific models (i.e., generalized linear mixed effects models)
