...
3. **Project** (15%): A group data analysis project will be completed throughout the course. Due dates and details will be posted in D2L.

4. **Final Exam** (20%): We will have a comprehensive in-class final exam on **Thursday, May 12, 8:00--9:50am** in our usual classroom. 
    - You may use up to 10 sheets (8.5" x 11", front and back) of notes on the final exam. (The purpose of allowing 10 sheets is to allow the sheets you used on prior quizzes, plus additional sheets for you to synthesize and review material from throughout the semester.)
    - You will not be asked to write R code on the final exam, but you may be asked to interpret R code and output.
